define(
  ...
  define(
    ...
    function (e, t, n) {
      ...
      o.inherits(r, l), (t.c_cppHighlightRules = r);
    }
  ),
  define(
          ...
          (this.foldingStartMarker = /([\{\[\(])[^\}\]\)]*$|^\s*(\/\*)/),
            ...
            (this.getFoldWidgetRange = function (e, t, n, r) {
              ...
              if ((o = i.match(this.foldingStartMarker))) {
                var l = o.index;
                if (o[1]) return this.openingBracketBlock(e, o[1], n, l);
                var a = e.getCommentFoldRange(n, l + o[0].length, 1);
                return (
                  a &&
                    !a.isMultiLine() &&
                    (r
              ...
              if ("markbegin" !== t && (o = i.match(this.foldingStopMarker))) {
                ...
                return o[1]
                  ? this.closingBracketBlock(e, o[1], n, l)
                  : e.getCommentFoldRange(n, l, -1);
              }
            }),
            (this.getSectionRange = function (e, t) {
              ...
              return new f(o, i, l, e.getLine(l).length);
            }),
            (this.getCommentRegionBlock = function (e, t, n) {
              for (
                ...
                t = e.getLine(n);
                var s = l.exec(t);
                if (s && (s[1] ? a-- : a++, !a)) break;
              }
              if (i < n) return new f(i, r, n, t.length);
            });
        }.call(i.prototype);
    }
  ),
  define(
    ...
    function (e, t, n) {
      ...
      var o = e("../lib/oop"),
        i = e("./text").Mode,
        l = e("./c_cpp_highlight_rules").c_cppHighlightRules,
        a = e("./matching_brace_outdent").MatchingBraceOutdent,
        s = (e("../range").Range, e("./behaviour/cstyle").CstyleBehaviour),
  ...
  window.require(["ace/mode/c_cpp"], function (e) {
