  ...
  if (
      ...
      h = function (e, i) {
        ...
        if (!t) {
          if ("function" == typeof (t = o.payloads[i])) {
            var n = {},
              s = { id: i, uri: "", exports: n, packaged: !0 };
            (n =
              t(
                function (e, t) {
                  return r(i, e, t);
    ...
    (i = e),
      ...
      (i.define && i.define.packaged) ||
        ((o.original = i.define), (i.define = o), (i.define.packaged = !0)),
      (i.require && i.require.packaged) ||
        ((l.original = i.require), (i.require = l), (i.require.packaged = !0));
  }
})(),
  define(
    "ace/lib/regexp",
      ...
      if (
        ...
        (Array.prototype.indexOf && -1 == [0, 1].indexOf(1, 2)) ||
          (Array.prototype.indexOf = function (e) {
            var t =
                C && "[object String]" == v(this) ? this.split("") : F(this),
              i = t.length >>> 0;
            if (!i) return -1;
            var n = 0;
            for (
  ...
  define(
    ...
    function (e, t, i) {
      ...
      (t.isWin = "win" == s),
        ...
        (t.isLinux = "linux" == s),
        (t.isIE =
          "Microsoft Internet Explorer" == r || 0 <= r.indexOf("MSAppHost")
            ? parseFloat(
                (o.match(
            ...
            : parseFloat(
                (o.match(/(?:Trident\/[0-9]+[\.0-9]+;.*rv:)([0-9]+[\.0-9]+)/) ||
                  [])[1]
              )),
    ...
    function (e, a, t) {
      ...
      if (
        ...
        (a.importCssString = function (e, t, i) {
          var n = i;
          (i && i.getRootNode && (n = i.getRootNode()) && n != i) ||
            (n = document);
  ...
  define(
    ...
    function (e, u, t) {
      ...
      function r(e, t, i) {
        ...
        if (
          (i in l.MODIFIER_KEYS && (i = -1), !n && 13 === i) &&
          3 === (s = "location" in t ? t.location : t.keyLocation) &&
        ...
        return (
          !!(n || i in l.FUNCTION_KEYS || i in l.PRINTABLE_KEYS) && e(t, n, i)
        );
      }
      function a() {
    ...
    function (e, t, i) {
      ...
      (t.TextInput = function (e, u) {
        ...
        var y = j
          ...
          : function () {
              if (!h && !f && (b || A)) {
                ...
                var l = i + "\n\n";
                if (
                  (l != p && ((d.value = p = l), (v = w = l.length)),
                  A && ((v = d.selectionStart), (w = d.selectionEnd)),
        ...
        function s(e, t) {
          ...
          for (
            r = r.slice(h), h = 1;
            0 < o && p.length - h > v - 1 && p[p.length - h] == e[e.length - h];
              ...
              h ||
                (r
                  ...
                  : 0 === (t = d).selectionStart &&
                    t.selectionEnd >= p.length &&
                    t.value === p &&
                    p &&
                    t.selectionEnd !== w
                  ? (u.selectAll(), y())
                  : X && d.selectionStart != v && y());
            },
            u
          ),
                ...
                s(e),
                  h.markerRange &&
                    ...
                    (h.markerRange.end.column =
                      h.markerRange.start.column + w - h.selectionStart + $));
              }
            }
          },
          R = function (e) {
            u.onCompositionEnd &&
              !u.$readOnly &&
              ((h = !1), u.onCompositionEnd(), u.off("mousedown", i), e && o());
          },
          ...
          (this.moveToMouse = function (e, t) {
            (c = c || d.style.cssText),
              (d.style.cssText =
                ...
                (B.isIE ? "opacity:0.1;" : "") +
                "text-indent: -" +
                (v + w) * u.renderer.characterWidth * 0.5 +
                "px;");
            function i(e) {
        ...
        function W(e) {
          if (
            ...
            !(I || h || T.$mouseHandler.isMousePressed || r)
          ) {
            ...
            if (
              (0 == t
                ...
                : t < v || (t == v && w != v && t == i)
                ? (n = K.left)
                : w < i && 2 < p.slice(0, i).split("\n").length
                ? (n = K.down)
                : w < i && " " == p[i - 1]
                ? ((n = K.right), (s = G.option))
                : (w < i || (i == w && w != v && t == i)) && (n = K.right),
              t !== i && (s |= G.shift),
              n)
            ) {
                      ...
                      (h && !r.isMousePressed
                        ? function () {
                            ...
                            if (e == u.session.getLength()) {
                              var i = u.renderer.pixelToScreenCoordinates(
                                  0,
                                  h.y
                                ).row,
                                n = h.$pos;
                              if (
                                i >
                                u.session.documentToScreenRow(n.row, n.column)
                              )
                                return a();
                            }
                            if (c != t)
      ...
      function n(t) {
        function e() {
          ...
          (u = g.renderer.screenToTextCoordinates(f, m)),
            ...
            !w || n || s
              ? (g.moveCursorToPosition(e), (w = i), ($ = { x: f, y: m }))
              : 5 < C($.x, $.y, f, m)
              ? (w = null)
              : 200 <= i - w && (g.renderer.scrollCursorIntoView(), (w = null)),
            (function (e, t) {
              var i = Date.now(),
              ...
              c || (u && !d)
                ? v
                  ? 200 <= i - v && g.renderer.scrollCursorIntoView(h)
                  : (v = i)
                : (v = null);
            })(u, o);
        }
      ...
      t.addTouchListeners = function (e, v) {
        function n() {
          function t(e) {
            ...
            "paste" == n
              ? s.readText().then(function (e) {
                  v.execCommand(n, e);
                })
              : n &&
                (("cut" != n && "copy" != n) ||
                  (s
                    ? s.writeText(v.getCopyText())
        ...
        function w() {
          ...
          (!e.isEmpty() && t) ||
            (v.selection.moveToPosition(x), v.selection.selectWord()),
            (k = "wait"),
            i();
        }
        var $,
        ...
        o.addListener(
          ...
          o.addListener(
            ...
            function (e) {
              var t = e.touches;
              if (C || 1 < t.length)
                return clearTimeout(C), (C = null), (y = -1), void (k = "zoom");
              ...
              if (
                ...
                R++,
                  ...
                  (function () {
                    ...
                    var e =
                      2 <= R
                        ? v.selection.getLineRange(x.row)
                        : v.session.getBracketRange(x);
                    e && !e.isEmpty()
                      ? v.selection.setRange(e)
                ...
                var m = f(
                    e.clientX - g.left - u.left,
                    e.clientY - g.top - u.top
                  ),
            ...
            function (e) {
              (A = v.$mouseHandler.isMousePressed = !1),
                ...
                "zoom" == k
                  ? ((k = ""), (L = 0))
                  : C
                  ? (v.selection.moveToPosition(x), (L = 0), i())
                  : "scroll" == k
                  ? ((L += 60),
                    (t = setInterval(function () {
                      L-- <= 0 && (clearInterval(t), (t = null)),
                        Math.abs(E) < 0.01 && (E = 0),
                        Math.abs(M) < 0.01 && (M = 0),
                        L < 20 && (E *= 0.9),
                        L < 20 && (M *= 0.9);
            ...
            function (e) {
              ...
              if (!(1 < t.length || "zoom" == k)) {
                ...
                if (((S = o), "scroll" == k)) {
                  ...
                  "cursor" == k
                    ? v.selection.moveCursorToPosition(l)
                    : "anchor" == k &&
                      v.selection.setSelectionAnchor(l.row, l.column),
    ...
    function (e, t, i) {
      ...
      (n._emit = n._dispatchEvent =
        ...
        (n.setDefaultHandler = function (e, t) {
          ...
          if ((i = i || (this._defaultHandlers = { _disabled_: {} }))[e]) {
            var n = i[e],
              s = i._disabled_[e];
    ...
    function (f, m, p) {
      ...
      var r = function () {
        w.basePath ||
          ...
          w.modePath ||
          w.themePath ||
          Object.keys(w.$moduleUrls).length ||
          (console.error(
      ...
      (m.init = function (e) {
        if (v && v.document) {
          w.packaged =
            e || f.packaged || p.packaged || (v.define && define.packaged);
          for (
            var t = {},
              i = "",
      ...
      function n(s) {
        ...
        c.addListener(
          ...
          u.isIE &&
            ...
            (c.addListener(s.renderer.scrollBarV.element, "mousedown", e, s),
          ...
          (v = i ? 1 : 0),
            (function (e, t, i, n) {
              var s = v ? C : S,
                ...
                d = null,
                g = [];
              if (!n) for (u = 0, n = []; u < i; u++) n[u] = p(e[u]);
      ...
      (function () {
        s.implement(this, o),
          ...
          (this.getLineRange = function (e, t) {
            ...
            return (
              (i = s ? ((n = s.start.row), s.end.row) : n),
              !0 === t
                ? new a(n, 0, i, this.session.getLine(i).length)
                : new a(n, 0, i + 1, 0)
            );
          }),
          ...
          (this.moveCursorBy = function (e, t) {
            ...
            if (
              ...
              e < 0
                ? (e -= s.rowsAbove || 0)
                : 0 < e && (e += s.rowCount - (s.rowsAbove || 0));
            }
            ...
            if (
              ...
              Array.isArray(h.token)
                ...
                : "function" != typeof h.token ||
                  h.onMatch ||
                  (h.onMatch = 1 < u ? this.$applyToken : h.token),
                1 < u &&
                  ((c = /\\\d/.test(h.regex)
                    ? h.regex.replace(/\\([0-9]+)/g, function (e, t) {
                        return "\\" + (parseInt(t, 10) + s + 1);
                      })
                    : ((u = 1), this.removeCapturingGroups(h.regex))),
                ...
                function (e, t, i, n, s, o) {
                  return (
                    a
                      ...
                      ? (a = !0)
                      : n
                      ? (r == l.stack && ((l.end = o + 1), (l.stack = -1)), r--)
                      : i &&
                        (r++, 1 != i.length && ((l.stack = r), (l.start = o))),
                    e
                  );
                }
              ),
          ...
          (this.getLineTokens = function (e, t) {
            ...
            for (
              ...
              if (m - f.length > h) {
                ...
                u.type == d
                  ? (u.value += p)
                  : (u.type && l.push(u), (u = { type: d, value: p }));
              }
              ...
              if (f)
                if ("string" == typeof d)
                  (g && !1 === g.merge) || u.type !== d
                    ? (u.type && l.push(u), (u = { type: d, value: f }))
                    : (u.value += f);
                else if (d) {
        ...
        (this.$defaultBehaviour = new a()),
            ...
            if (this.lineCommentStart) {
              ...
              var u = g + " ",
                d =
                  ((v = function (e, t) {
                    (r && !/\S/.test(e)) ||
                      (d(e, l, l)
                        ? o.insertInLine({ row: t, column: l }, u)
                        : o.insertInLine({ row: t, column: l }, g));
                  }),
                  ($ = function (e, t) {
                    return m.test(e);
                  }),
              ...
              var g = this.blockComment.start,
                ...
                v = function (e, t) {
                  $(e, t) ||
                    (r && !/\S/.test(e)) ||
                    (o.insertInLine({ row: t, column: e.length }, f),
                    o.insertInLine({ row: t, column: l }, g));
                },
                w = function (e, t) {
                  var i;
          ...
          (this.toggleBlockComment = function (e, t, i, n) {
            ...
            if (s) {
              ...
              var o,
                r,
                a = (g = new m(t, n.row, n.column)).getCurrentToken(),
              ...
              if (a && /comment/.test(a.type)) {
                ...
                c && t.remove(c),
                  h && (t.remove(h), (o = h.start.row), (r = -s.start.length));
              } else
                (r = s.start.length),
                  (o = i.start.row),
          ...
          (this.$onChange = function (e) {
            ...
            if ("insert" == e.action)
              ...
              for (l = n - s, h = t.column - i.column; r < a; r++) {
                ...
                c.end.row < s &&
                (n < c.end.row || (n == c.end.row && t.column < c.end.column))
                  ? ((c.end.row = n), (c.end.column = t.column))
                  : c.end.row == s
            ...
            (this.addSubFold = function (e) {
              if (!this.range.isEqual(e)) {
                ...
                for (
                  ...
                  1 == (r = this.subFolds[h].range.compare(n, s));
                  h++
                );
                0 == r && h++;
                for (
                  var c = this.subFolds.splice(o, h - o, e),
                    u = 0 == r ? c.length - 1 : c.length,
                    d = l;
                  d < u;
                  d++
                )
        ...
        (this.getFoldAt = function (e, t, i) {
          ...
          (this.getParentFoldRangeData = function (e, t) {
            ...
            for (var n, s = e - 1; 0 <= s; ) {
              var o = i[s];
              if (
                (null == o && (o = i[s] = this.getFoldWidget(s)), "start" == o)
              ) {
          ...
          n.implement(this, l),
            ...
            (this.getWordRange = function (e, t) {
              var i = this.getLine(e),
                n = !1;
              if (
                (0 < t && (n = !!i.charAt(t - 1).match(this.tokenRe)),
            ...
            (this.screenToDocumentPosition = function (e, t, i) {
              ...
              for (
                var g = this.getLength() - 1,
                  ...
                  m = f ? f.start.row : 1 / 0;
                a <= e && !(e < a + (l = this.getRowLength(o)) || g <= o);

              )
                (a += l),
                  m < ++o &&
                    ((o = f.end.row + 1),
                    (m = (f = this.getNextFoldLine(o, f))
                      ? f.start.row
                      : 1 / 0)),
                  d &&
                    (this.$docRowCache.push(o), this.$screenRowCache.push(a));
              if (f && f.start.row <= o)
            ...
            (this.documentToScreenPosition = function (e, t) {
              ...
              for (
                ...
                (s += this.getRowLength(a)),
                  (a = r),
                  u &&
                    (this.$docRowCache.push(a), this.$screenRowCache.push(s));
              }
              var f = "";
              o =
                d && g <= a
              ...
              return (
                ...
                { row: s, column: m + this.$getStringScreenWidth(f)[0] }
              );
            }),
        ...
        (this.set = function (e) {
          ...
          (this.findAll = function (e) {
            ...
            if (i) {
              ...
              for (
                m = 0, c = s.length - 1;
                m < c && s[m].start.column < w && s[m].start.row == i.start.row;
          ...
          (this.$matchIterator = function (c, i) {
            ...
            if (l)
              var r = function (e) {
                var t = n.row;
                if (!a(t, n.column, e)) {
                  for (t--; s <= t; t--) if (a(t, Number.MAX_VALUE, e)) return;
                  if (0 != i.wrap)
              ...
              r = function (e) {
                var t = n.row;
                if (!a(t, n.column, e)) {
                  for (t += 1; t <= o; t++) if (a(t, 0, e)) return;
                  if (0 != i.wrap)
                    for (t = s, o = n.row; t <= o; t++) if (a(t, 0, e)) return;
                }
              };
            if (i.$isMultiLine)
              var h = u.length,
            ...
            (this._addCommandToBinding = function (e, t, i) {
              ...
              if (t)
                if (!s[e] || this.$singleCommand) s[e] = t;
                  ...
                  Array.isArray(s[e])
                    ? -1 != (n = s[e].indexOf(t)) && s[e].splice(n, 1)
                    : (s[e] = [s[e]]),
                  ...
                  setTimeout(function () {
                    ...
                    if (t && t.bgTokenizer) {
                      ...
                      if (
                        (!e &&
                          t.$mode.getMatching &&
                          (e = t.$mode.getMatching(n.session)),
                        e)
                      ) {
                        var i = "ace_bracket";
                        Array.isArray(e)
                          ? 1 == e.length && (i = "ace_error_bracket")
                          : (e = [e]),
                          2 == e.length &&
                            (0 == m.comparePoints(e[0].end, e[1].start)
                              ? (e = [m.fromPoints(e[0].start, e[1].end)])
                              : 0 == m.comparePoints(e[0].start, e[1].end) &&
                                (e = [m.fromPoints(e[1].start, e[0].end)])),
                          (t.$bracketHighlight = {
                            ranges: e,
            ...
            (this.autoIndent = function () {
              ...
              for (
                ...
                0 < d &&
                  ...
                  c !== (r = n.$getIndent(o)) &&
                    (0 < r.length &&
                      ((a = new m(d, 0, d, r.length)), i.remove(a)),
                    0 < c.length && i.insert({ row: d, column: 0 }, c)),
                  n.autoOutdent(l, i, d);
            }),
              ...
              if (!isNaN(parseFloat(s)) && isFinite(s)) {
                ...
                if (o) {
                  ...
                  this.session.replace(c, h),
                    this.moveCursorTo(
                      t,
                      Math.max(o.start + 1, i + h.length - o.value.length)
                    );
                }
      ...
      function l(e, t) {
        ...
        if (i && n) m(e.start, t.start) < 0 ? h(t, e, 1) : h(e, t, 1);
          ...
          0 <= m(e.start, t.end)
            ? h(e, t, -1)
            : (m(e.start, t.start) <= 0 ||
                h(e, f.fromPoints(t.start, e.start), -1),
              h(t, e, 1));
        else if (!i && n)
          0 <= m(t.start, e.end)
            ? h(t, e, -1)
            : (m(t.start, e.start) <= 0 ||
                h(t, f.fromPoints(e.start, t.start), -1),
              h(e, t, 1));
        else if (!i && !n)
          if (0 <= m(t.start, e.end)) h(t, e, -1);
          else {
            ...
            if (!(m(t.end, e.start) <= 0))
              return (
                m(e.start, t.start) < 0 && (e = u((s = e), t.start)),
    ...
    function (e, t, i) {
      ...
      (function () {
        s.implement(this, o),
          ...
          (this.$renderCell = function (e, t, i, n) {
            ...
            return (
              ...
              w.setStyle(
                e.element.style,
                "height",
                this.$lines.computeLineHeight(n, t, o) + "px"
              ),
              w.setStyle(
                e.element.style,
                "top",
                this.$lines.computeLineTop(n, t, o) + "px"
              ),
              (e.text = v),
              e
            );
          ...
          (this.setShowFoldWidgets = function (e) {
            e
              ? w.addCssClass(this.element, "ace_folding-enabled")
              : w.removeCssClass(this.element, "ace_folding-enabled"),
      ...
      (function () {
        s.implement(this, r),
              ...
              if (this.displayIndentGuides) {
                ...
                var n,
                  ...
                  o = this.showSpaces
                    ...
                    : "",
                  r = this.showSpaces
                    ? w.stringRepeat(this.SPACE_CHAR, this.tabSize)
                    : w.stringRepeat(" ", this.tabSize),
                  a = this.showTabs ? " ace_invisible ace_invisible_tab" : "",
                  l = this.showTabs
                    ? w.stringRepeat(this.TAB_CHAR, this.tabSize)
                    : r;
          ...
          (this.updateLines = function (e, t, i) {
            ...
            for (
              var l,
                ...
                c =
                  ((a = n),
                  (l = this.session.getNextFoldLine(a)) ? l.start.row : 1 / 0);
              c < a &&
                ((a = l.end.row + 1),
              ...
              if (u) {
                this.dom.removeChildren(u),
                  ...
                  h &&
                    (u.style.top =
                      this.$lines.computeLineTop(a, e, this.session) + "px");
          ...
          (this.$renderToken = function (e, t, i, n) {
            for (
              ...
              if (o.showSpaces || !c) {
                ...
                if (
                  ...
                  if (o.showSpaces) {
                    ((v = this.dom.createElement("span")).className =
                      "ace_invisible ace_invisible_space"),
                  ...
                  (t += 1),
                    ((v = this.dom.createElement("span")).style.width =
                      2 * o.config.characterWidth + "px"),
                    (v.className = o.showSpaces
            ...
            if (
              (a.appendChild(
                this.dom.createTextNode(l ? n.slice(l) : n, this.element)
              ),
          ...
          (this.$renderWrappedLine = function (e, t, i) {
            ...
            i[i.length - 1] > this.MAX_LINE_LENGTH &&
              this.$renderOverflowMessage(a, r, null, "", !0);
          }),
                    ...
                    : (s && (a = o.getTokens(t)),
                      a.length &&
                        (function (e, t, i) {
                          ...
                          for (
                            s != t &&
                            ((o = e[n].value.substring(t - s)).length > i - t &&
                              (o = o.substring(0, i - t)),
                            r.push({ type: e[n].type, value: o }),
                            (s = t + o.length),
                            (n += 1));
                            s < i && n < e.length;
    ...
    function (e, t, i) {
      ...
      function n(e, t) {
        ...
        this._flush = function (e) {
          ...
          var t = i.changes;
          if (
            (t && (s.blockIdle(100), (i.changes = 0), i.onRender(t)), i.changes)
          ) {
      ...
      (function () {
        (this.schedule = function (e) {
          (this.changes = this.changes | e),
            this.changes &&
              !this.pending &&
              (s.nextFrame(this._flush), (this.pending = !0));
        }),
      ...
      (function () {
        n.implement(this, l),
          ...
          (this.$measureCharWidth = function (e) {
            return (
              (this.$main.textContent = o.stringRepeat(e, 256)),
      ...
      (function () {
        (this.CHANGE_CURSOR = 1),
              ...
              if (this.$keepTextAreaAtCursor || t) {
                ...
                if (i) {
                  ...
                  if (s < 0 || s > n.height - r)
                    ...
                    (o -= this.scrollLeft) > this.$size.scrollerWidth - a &&
          ...
          (this.$computeLayerConfig = function () {
            ...
            var g,
              f,
              m = this.scrollTop % this.lineHeight,
              p = Math.ceil(l / this.lineHeight) - 1,
              v = Math.max(
                0,
                Math.round((this.scrollTop - m) / this.lineHeight)
              ),
              w = v + p,
              $ = this.lineHeight;
            ...
            return (
              ...
              (this.layerConfig = {
                ...
                gutterOffset: $
                  ? Math.max(
                      0,
                      Math.ceil((m + t.height - t.scrollerHeight) / $)
                    )
                  : 0,
          ...
          (this.showComposition = function (e) {
            (this.$composition = e).cssText ||
              ...
              this.$useTextareaForIME
                ? (c.addCssClass(this.textarea, "ace_composition"),
      ...
      t.onMouseDown = function (e) {
        ...
        if (
          ...
          if (0 === r) {
            ...
            if (
              (a && R.isMac && t.ctrlKey && l.$mouseHandler.cancelContextMenu(),
              "add" == a)
            ) {
              if (!c && g) return;
              if (!c) {
              ...
              (l.inVirtualSelectionMode = !0),
                ...
                l.once("mouseup", function () {
                  ...
                  b && e.isEmpty() && k(b.cursor, e.cursor)
                    ? h.substractPoint(e.cursor)
                    : (n
                        ? h.substractPoint($.cursor)
                        : $ && (l.removeSelectionMarker($), h.addRange($)),
                      h.addRange(e)),
              ...
              c && !o
                ...
                : !c &&
                  o &&
                  ((S = h.toOrientedRange()), l.addSelectionMarker(S)),
                n
                  ? (v = p.documentToScreenPosition(h.lead))
                  : h.moveToPosition(u),
                (w = { row: -1, column: -1 });
              var x = y;
              L.capture(
                ...
                function (e) {
                  y(),
                    ...
                    S && (l.removeSelectionMarker(S), h.toSingleRange(S));
            ...
            r.addListener(
              ...
              function (e) {
                ...
                i.$blockSelectEnabled && t
                  ? s || (i.renderer.setMouseCursor("crosshair"), (s = !0))
                  : s && n();
              },
              i
            ),
        ...
        function () {
          (this.ranges = null),
            ...
            (this.rectangularRangeBlock = function (e, t, i) {
              ...
              for (var m = g; m <= f; m++) {
                var p = b.fromPoints(
                  this.session.screenToDocumentPosition(m, o, a),
              ...
              if ((d && n.reverse(), !i)) {
                ...
                if (0 < v) for (var w = 0; n[w].isEmpty(); ) w++;
      ...
      (function () {
        (this.updateSelectionMarkers = function () {
              ...
              if (t.multiSelectAction)
                n =
                  "forEach" == t.multiSelectAction
                    ? i.forEachSelection(t, e.args)
                    : "forEachLine" == t.multiSelectAction
                    ? i.forEachSelection(t, e.args, !0)
                    : "single" == t.multiSelectAction
                    ? (i.exitMultiSelectMode(), t.exec(i, e.args || {}))
                    : t.multiSelectAction(i, e.args || {});
              else {
          ...
          (this.selectMoreLines = function (e, t) {
            ...
            var o,
              r = this.session.screenToDocumentPosition(s.row + e, s.column);
            if (i.isEmpty()) l = r;
            else
            ...
            n
              ? ((o = b.fromPoints(r, l)).cursor = o.start)
              : ((o = b.fromPoints(l, r)).cursor = o.end);
            if (
              ((o.desiredColumn = s.column), this.selection.inMultiSelectMode)
            ) {
              if (t) var h = i.cursor;
      ...
      (function () {
        (this.getRowLength = function (e) {
          ...
          (this.addLineWidget = function (e) {
            ...
            e.html &&
              !e.el &&
              ((e.el = s.createElement("div")), (e.el.innerHTML = e.html)),
              e.el &&
